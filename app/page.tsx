        ...
        <div className="container max-w-5xl mx-auto">
          ...
          >
            ...
            <motion.p 
              ...
              variants={item}
            >
              Use ImageZero to convert and compress images directly in your browser with complete privacy.
          ...
          >
            ...
            >
              <TabsContent value="convert" className="mt-0 p-1">
                <div className="bg-linear-to-r from-blue-50 to-violet-50 dark:from-blue-950/20 dark:to-violet-950/20 p-8 rounded-xl">
                  <ImageConverter />
                </div>
              </TabsContent>
      ...
      <section className="py-16 px-4 z-10">
        <div className="container max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              {
                title: "ImageZero Conversion",
                description: "Convert between multiple image formats with ImageZero's fast WebAssembly-powered engine",
                icon: <FileImage className="h-8 w-8 text-primary" />
              },
              {
                title: "ImageZero Compression",
                description: "Reduce file sizes while maintaining quality with ImageZero's advanced algorithms",
                icon: <FileImage className="h-8 w-8 text-primary" />
              },
              {
                title: "ImageZero Batch Processing",
                description: "Process multiple images at once with ImageZero's efficient batch processing system",
                icon: <FileImage className="h-8 w-8 text-primary" />
              }
            ].map((feature, index) => (
              <motion.div 
      ...
      <footer className="py-6 border-t">
        <div className="container max-w-5xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            <span className="font-medium gradient-text">ImageZero</span> - Universal image converter and compressor
          </p>
