/* tslint:disable */
/* eslint-disable */
export function compress_image(input_data: Uint8Array, format: string, quality: number): Uint8Array;
export function convert_image(input_data: Uint8Array, format: string): Uint8Array;
export function resize_image(input_data: Uint8Array, format: string, scale_percentage: number): Uint8Array;
